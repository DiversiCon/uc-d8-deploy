 ...
 *
 * @MigrateSource(
 *   id = "d7_node_story_image_wide",
 *   source_module = "node"
 * )
 */
class D7NodeStoryImageWide extends DrupalSqlBase {
  ...
  public function prepareRow(Row $row) {
    ...
    // Map of files to exclude.
    $helper = new MigrateHelper();
    $exclude = $helper->getInsetImages();

    // Skip anything in the exclude map.
