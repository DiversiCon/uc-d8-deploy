 ...
 *
 * @RestResource(
 *   id = "basic_images_rest_resource",
 *   label = @Translation("Basic images"),
 *   uri_paths = {
 *     "canonical" = "/migrate/basic_images"
 *   }
 * )
 */
class BasicImagesRestResource extends ResourceBase {
          ...
          foreach ($media_fields as $media_field) {
            ...
            if (isset($source_row[$media_field]) && !empty($source_row[$media_field])) {
              ...
              foreach ($source_row[$media_field] as $delta => $field_values) {
                ...
                $image_metadata = $helper->normalizeImageMetadata('basic', $media_field, $field_values);
