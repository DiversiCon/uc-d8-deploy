 ...
 *
 * @RestResource(
 *   id = "publication_images_rest_resource",
 *   label = @Translation("Publication images"),
 *   uri_paths = {
 *     "canonical" = "/migrate/publication_images"
 *   }
 * )
 */
class PublicationImagesRestResource extends ResourceBase {
          ...
          foreach ($media_fields as $media_field) {
            ...
            if (isset($source_row[$media_field]) && !empty($source_row[$media_field])) {
              ...
              foreach ($source_row[$media_field] as $delta => $field_values) {
                ...
                $image_metadata = $helper->normalizeImageMetadata('pubs', $media_field, $field_values);
