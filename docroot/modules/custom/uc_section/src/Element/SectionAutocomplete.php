...
namespace Drupal\uc_section\Element;

use Drupal\Core\Entity\Element\EntityAutocomplete;
use Drupal\Core\Form\FormStateInterface;

/**
 * Provides a section autocomplete form element.
 *
 * The #default_value accepted by this element is either an entity object or an
 * array of entity objects.
 *
 * @FormElement("uc_section_autocomplete")
 */
class SectionAutocomplete extends EntityAutocomplete {
  ...
  public static function processEntityAutocomplete(array &$element, FormStateInterface $form_state, array &$complete_form) {
    ...
    $element['#autocomplete_route_name'] = 'uc_section.section_autocomplete';
